...
| [`ksl-fleet`](ksl-fleet.md) *(experimental)* | **Active guided vehicles** — the same guide path, with the decision moved out of the entity and into a dispatcher that can batch, negotiate, and take work back |
